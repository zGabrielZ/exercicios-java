...
class SolucaoPapelPartidaServiceImplTest {
    ...
    @Test
    @DisplayName("Dado primeiro adversário papel e segundo adversário pedra, quando solucionar partida, então deve retornar vitória para o primeiro adversário")
    void dadoPrimeiroAdversarioPapelSegundoAdversarioPedra_quandoSolucionarPartida_entaoDeveRetornarVitoriaParaPrimeiroAdversario() {
        Gesto primeiroGesto = Gesto.PAPEL;
    ...
    @Test
    @DisplayName("Dado primeiro adversário papel e segundo adversário papel, quando solucionar partida, então deve retornar empate para ambos")
    void dadoPrimeiroAdversarioPapelSegundoAdversarioPapel_quandoSolucionarPartida_entaoDeveRetornarEmpateParaAmbos() {
        Gesto primeiroGesto = Gesto.PAPEL;
    ...
    @Test
    @DisplayName("Dado primeiro adversário papel e segundo adversário tesoura, quando solucionar partida, então deve retornar derrota para o primeiro adversário")
    void dadoPrimeiroAdversarioPapelSegundoAdversarioTesoura_quandoSolucionarPartida_entaoDeveRetornarDerrotaParaPrimeiroAdversario() {
        Gesto primeiroGesto = Gesto.PAPEL;
